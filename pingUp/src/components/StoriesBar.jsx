      ...
      <div className="flex gap-4 pb-4">
        ...
        {stories.map((story, index) => (
          <div
            ...
            className="relative rounded-lg shadow min-w-[120px] max-h-40 cursor-pointer hover:shadow-lg transition-all duration-200 bg-gradient-to-b from-indigo-500 to-purple-600 hover:from-indigo-700 hover:to-purple-800 active:scale-95"
          >
            <img
              ...
              <div className="absolute inset-0 z-[1] rounded-lg bg-black overflow-hidden">
                {story.media_type === 'image' ? (
                  <img
                    src={story.media_url}
                    alt="story"
                    className="w-full h-full object-cover hover:scale-110 transition duration-500 opacity-70 hover:opacity-70"
                  />
                ) : (
                  <video
                    src={story.media_url}
